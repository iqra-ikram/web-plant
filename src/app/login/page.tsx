...
const page = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
    <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
      <h1 className="title-font font-medium text-3xl text-gray-900">Need Help?</h1>
      <p className="leading-relaxed mt-4">If you’re having trouble logging in or need assistance, feel free to or check our page.
